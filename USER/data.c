...
void XUI_data1()
{
	...
	else XUI_num(18,20,hud_alt/10,4,12,1,PC,BC);
...
//	u8 tlm0=0;
	...
	else XUI_str(36,20,100,12,(u8*)"未连接",12,1,PC,BC);
	...
	else XUI_str(36,32,100,12,(u8*)"未连接",12,1,PC,BC);
	...
	else XUI_str(116,20,100,12,(u8*)"未连接",12,1,PC,BC);
	...
	else XUI_str(116,32,100,12,(u8*)"未连接",12,1,PC,BC);
